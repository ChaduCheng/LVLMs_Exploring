        ...
        for p in prefixs:
            ...
            for datasets in total_datasets:
                for dataset in datasets:
                    if informative:
                        log_file = os.path.join(log_root, dataset + '-' + model_name + '-' + question + '-informative' )
                    else:
                        log_file = os.path.join(log_root, dataset + '-' + model_name + '-' + question)
                        ...
                        for image_file in tqdm(image_files):
                            ...
                            while True:
                                try:
                                    ...
                                    if informative:
                                        label = f"an image of {label} with a word \"{mislabel}\" written on top of it"
                                        mislabel = f"an image of {mislabel} with a word \"{mislabel}\" written on top of it"
