...
def main(args):
    ...
    prefixs =  ["{}: Answer with the option's letter from the given choices directly. ",
                ...
                "{}: Provide analysis by examining the problem and image. After detailed assessment, conclude your response by selecting the option from given choices, ending with either (a) or (b). ",                
