...
def main(args):
    ...
    # log_root = 'logs'
    # data_root = 'images'
    # total_datasets = [['numerical-r' + str(r) for r in range(4)],
    ...
    # total_datasets = [['numerical-esp' + str(esp) for esp in [4, 8, 16, 32]]]
    
    # large 数据集
    log_root = 'logs'
    data_root = "dataset/classification"
    total_datasets = [['numerical-large-r' + str(r) for r in range(2)]]
