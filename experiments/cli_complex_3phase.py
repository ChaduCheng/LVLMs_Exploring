...
def main(args):
    ...
    prefixs =  ["{}: Answer with the option's letter from the given choices directly. ",
                ...
                "{}: Focus on the visual aspects of the image, including colors, shapes, composition, and any notable visual themes. Provide a detailed visual description of the image to answer the following question. Take a deep breath and work on this problem step by step. ",
    ...
    # log_name = 'D2SkipQ'
    # log_name = 'D2SkipQ2'
    # log_name = 'D2COT3Phase'
    # log_name = 'D2CON3Phase'
    log_name = 'D2IgnoreTypo3Phase'
    
    total_datasets = [['complex-r' + str(r) for r in range(2)],]
    prefixs = [prefixs[-1]]
                    ...
                    with open(log_file, 'w') as f:
                        ...
                        for image_file in tqdm(image_files):
                            ...
                            while True:
                                ...
                                if count==0:
                                    inp = question.format(roles[0], challenge, label, mislabel)
                                if count==1:
                                    inp = "{}: Based on your previous description, please delve deeper into the visual details of the image and include any subtle details or elements that were not covered in your initial description to answer the following question. " + q
                                    inp = inp.format(roles[0], challenge, label, mislabel)
                                if count==2:
