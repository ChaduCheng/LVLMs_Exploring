...
def main(args):
    ...
    total_datasets = [['counting-r' + str(r) for r in range(4)],
    ...
    # log_root = 'logs'
    # data_root = "dataset/classification"
    # total_datasets = [['counting-esp' + str(esp) for esp in [4, 8, 16, 32]]]

    # large 数据集
    # log_root = 'logs'
    # data_root = "dataset/classification"
    # total_datasets = [['counting-large-r' + str(r) for r in range(2)]]
